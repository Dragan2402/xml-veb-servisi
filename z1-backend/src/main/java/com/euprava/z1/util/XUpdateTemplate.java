...
public class XUpdateTemplate {
     ...
     *
     */
    public static String getInsertAfterExpresson(String targetNamespace) {
        return "<xu:modifications version=\"1.0\" xmlns:xu=\""
                + XUpdateProcessor.XUPDATE_NS + "\" xmlns=\"" + targetNamespace + "\">"
     ...
     */
    public static String getInsertBeforeExpression(String targetNamespace) {
        return "<xu:modifications version=\"1.0\" xmlns:xu=\""
                + XUpdateProcessor.XUPDATE_NS + "\" xmlns=\"" + targetNamespace + "\">"
     ...
     */
    public static String getAppendExpression(String targetNamespace) {
        return "<xu:modifications version=\"1.0\" xmlns:xu=\"" + XUpdateProcessor.XUPDATE_NS
                + "\" xmlns=\"" + targetNamespace + "\">" + "<xu:append select=\"%1$s\" child=\"last()\">%2$s</xu:append>"
                + "</xu:modifications>";
    }
    /*
     ...
     * node-set.
     */
    public static String getUpdateExpression(String targetNamespace) {
        return "<xu:modifications version=\"1.0\" xmlns:xu=\"" + XUpdateProcessor.XUPDATE_NS
     ...
     * to a node-set.
     */
    public static String getRemoveExspression(String targetNamespace) {
        return "<xu:modifications version=\"1.0\" xmlns:xu=\"" + XUpdateProcessor.XUPDATE_NS
                + "\" xmlns=\"" + targetNamespace + "\">" + "<xu:remove select=\"%1$s\"/>" + "</xu:modifications>";
    }
}
